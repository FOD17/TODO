"use strict";(()=>{var e={};e.id=191,e.ids=[191],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},6026:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{originalPathname:()=>y,patchFetch:()=>E,requestAsyncStorage:()=>p,routeModule:()=>T,serverHooks:()=>u,staticGenerationAsyncStorage:()=>d});var r=a(9303),n=a(8716),s=a(670),c=a(5863),i=e([c]);c=(i.then?(await i)():i)[0];let T=new r.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/tags/route",pathname:"/api/tags",filename:"route",bundlePath:"app/api/tags/route"},resolvedPagePath:"/Users/markwilliams/Documents/Developer-Projects/TODO-Tracker/app/api/tags/route.js",nextConfigOutput:"",userland:c}),{requestAsyncStorage:p,staticGenerationAsyncStorage:d,serverHooks:u}=T,y="/api/tags/route";function E(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:d})}o()}catch(e){o(e)}})},5863:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{GET:()=>c,PUT:()=>i,dynamic:()=>E});var r=a(7070),n=a(6385),s=e([n]);n=(s.then?(await s)():s)[0];let E="force-dynamic";async function c(){try{let e=await n.db.getTags();return r.NextResponse.json(e)}catch(e){return console.error("[API /tags GET]",e.message),r.NextResponse.json({error:e.message},{status:500})}}async function i(e){try{let t=await e.json(),a=await n.db.saveTags(t);return r.NextResponse.json(a)}catch(e){return console.error("[API /tags PUT]",e.message),r.NextResponse.json({error:e.message},{status:500})}}o()}catch(e){o(e)}})},6385:(e,t,a)=>{a.a(e,async(e,o)=>{try{let E;a.d(t,{db:()=>p});var r=a(8678),n=e([r]);function s(){return E||(E=new r.Pool({connectionString:process.env.DATABASE_URL||"postgresql://localhost:5431/postgres",ssl:"require"===process.env.DATABASE_SSL&&{rejectUnauthorized:!1}})).on("error",e=>{console.error("[DB] Unexpected pool error:",e.message)}),E}function c(e){if(!e)return e;let t=e.names;return t&&""!==t&&"{}"!==t?"string"==typeof t?t=t.replace(/^\{|\}$/g,"").split(",").map(e=>e.trim()).filter(Boolean):Array.isArray(t)||(t=[]):t=[],{...e,names:t,subtasks:e.subtasks||[],notes:e.notes||[],labels:e.labels||[]}}function i(e){return e?Array.isArray(e)?e.join(","):String(e):""}r=(n.then?(await n)():n)[0];let T=`
...
`,p={async getTodos(){let e=s(),[t,a]=await Promise.all([e.query(`${T} WHERE completed = false ORDER BY date DESC`),e.query(`${T} WHERE completed = true ORDER BY date DESC`)]);return{active:t.rows.map(c),completed:a.rows.map(c)}},async addTodo(e){let t=s(),a=e.id||Date.now().toString();await t.query(`INSERT INTO todos (id, message, date, company, names, accountrep, completed, description)
       VALUES ($1, $2, $3, $4, $5, $6, false, $7)`,[a,e.message,e.date,e.company||"",i(e.names),e.accountRep||"",e.description||""]);let o=await t.query(`${T} WHERE id = $1`,[a]);return c(o.rows[0])},async updateTodo(e,t){let a=s(),o={message:"message",date:"date",company:"company",names:"names",accountRep:"accountrep",description:"description"},r=Object.keys(t).filter(e=>o[e]);if(r.length>0){let n=r.map((e,t)=>`${o[e]} = $${t+1}`).join(", "),s=r.map(e=>"names"===e?i(t[e]):t[e]);s.push(e),await a.query(`UPDATE todos SET ${n}, updatedat = CURRENT_TIMESTAMP WHERE id = $${s.length}`,s)}let n=await a.query(`${T} WHERE id = $1`,[e]);return c(n.rows[0])},async deleteTodo(e){let t=s();await t.query("DELETE FROM todos WHERE id = $1",[e])},async completeTodo(e){let t=s();await t.query("UPDATE todos SET completed = true, updatedat = CURRENT_TIMESTAMP WHERE id = $1",[e])},async uncompleteTodo(e){let t=s();await t.query("UPDATE todos SET completed = false, updatedat = CURRENT_TIMESTAMP WHERE id = $1",[e])},async saveTodos(e){let t=s(),a=e.active||[],o=e.completed||[],r=new Date().toISOString(),n=`
    ...
    `);try{await e.query("ALTER TABLE todos ADD COLUMN IF NOT EXISTS description TEXT")}catch{}console.log("[DB] Tables ready")}};o()}catch(e){o(e)}})}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),o=t.X(0,[276,972],()=>a(6026));module.exports=o})();