"use strict";(()=>{var e={};e.id=729,e.ids=[729],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},9673:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{originalPathname:()=>y,patchFetch:()=>E,requestAsyncStorage:()=>p,routeModule:()=>T,serverHooks:()=>u,staticGenerationAsyncStorage:()=>d});var n=a(9303),r=a(8716),s=a(670),c=a(5767),i=e([c]);c=(i.then?(await i)():i)[0];let T=new n.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/config/route",pathname:"/api/config",filename:"route",bundlePath:"app/api/config/route"},resolvedPagePath:"/Users/markwilliams/Documents/Developer-Projects/TODO-Tracker/app/api/config/route.js",nextConfigOutput:"",userland:c}),{requestAsyncStorage:p,staticGenerationAsyncStorage:d,serverHooks:u}=T,y="/api/config/route";function E(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:d})}o()}catch(e){o(e)}})},5767:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{GET:()=>c,PUT:()=>i,dynamic:()=>E});var n=a(7070),r=a(6385),s=e([r]);r=(s.then?(await s)():s)[0];let E="force-dynamic";async function c(){try{let e=await r.db.getConfig();return n.NextResponse.json(e)}catch(e){return console.error("[API /config GET]",e.message),n.NextResponse.json({error:e.message},{status:500})}}async function i(e){try{let t=await e.json(),a=await r.db.updateConfig(t);return n.NextResponse.json(a)}catch(e){return console.error("[API /config PUT]",e.message),n.NextResponse.json({error:e.message},{status:500})}}o()}catch(e){o(e)}})},6385:(e,t,a)=>{a.a(e,async(e,o)=>{try{let E;a.d(t,{db:()=>p});var n=a(8678),r=e([n]);function s(){return E||(E=new n.Pool({connectionString:process.env.DATABASE_URL||"postgresql://localhost:5431/postgres",ssl:"require"===process.env.DATABASE_SSL&&{rejectUnauthorized:!1}})).on("error",e=>{console.error("[DB] Unexpected pool error:",e.message)}),E}function c(e){if(!e)return e;let t=e.names;return t&&""!==t&&"{}"!==t?"string"==typeof t?t=t.replace(/^\{|\}$/g,"").split(",").map(e=>e.trim()).filter(Boolean):Array.isArray(t)||(t=[]):t=[],{...e,names:t,subtasks:e.subtasks||[],notes:e.notes||[],labels:e.labels||[]}}function i(e){return e?Array.isArray(e)?e.join(","):String(e):""}n=(r.then?(await r)():r)[0];let T=`
...
`,p={async getTodos(){let e=s(),[t,a]=await Promise.all([e.query(`${T} WHERE completed = false ORDER BY date DESC`),e.query(`${T} WHERE completed = true ORDER BY date DESC`)]);return{active:t.rows.map(c),completed:a.rows.map(c)}},async addTodo(e){let t=s(),a=e.id||Date.now().toString();await t.query(`INSERT INTO todos (id, message, date, company, names, accountrep, completed, description)
    ...
    `);try{await e.query("ALTER TABLE todos ADD COLUMN IF NOT EXISTS description TEXT")}catch{}console.log("[DB] Tables ready")}};o()}catch(e){o(e)}})}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),o=t.X(0,[276,972],()=>a(9673));module.exports=o})();