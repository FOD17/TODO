"use strict";(()=>{var e={};e.id=350,e.ids=[350],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},2273:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{originalPathname:()=>y,patchFetch:()=>E,requestAsyncStorage:()=>T,routeModule:()=>d,serverHooks:()=>u,staticGenerationAsyncStorage:()=>p});var n=a(9303),r=a(8716),s=a(670),c=a(8796),i=e([c]);c=(i.then?(await i)():i)[0];let d=new n.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/contacts/[id]/route",pathname:"/api/contacts/[id]",filename:"route",bundlePath:"app/api/contacts/[id]/route"},resolvedPagePath:"/Users/markwilliams/Documents/Developer-Projects/TODO-Tracker/app/api/contacts/[id]/route.js",nextConfigOutput:"",userland:c}),{requestAsyncStorage:T,staticGenerationAsyncStorage:p,serverHooks:u}=d,y="/api/contacts/[id]/route";function E(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:p})}o()}catch(e){o(e)}})},8796:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{DELETE:()=>i,PATCH:()=>c});var n=a(7070),r=a(6385),s=e([r]);async function c(e,{params:t}){try{let{company:a,...o}=await e.json(),s=await r.db.updateContact(a,t.id,o);return n.NextResponse.json(s)}catch(e){return console.error("[API /contacts/[id] PATCH]",e.message),n.NextResponse.json({error:e.message},{status:500})}}async function i(e,{params:t}){try{let{searchParams:a}=new URL(e.url),o=a.get("company");return await r.db.deleteContact(o,t.id),n.NextResponse.json({ok:!0})}catch(e){return console.error("[API /contacts/[id] DELETE]",e.message),n.NextResponse.json({error:e.message},{status:500})}}r=(s.then?(await s)():s)[0],o()}catch(e){o(e)}})},6385:(e,t,a)=>{a.a(e,async(e,o)=>{try{let E;a.d(t,{db:()=>T});var n=a(8678),r=e([n]);function s(){return E||(E=new n.Pool({connectionString:process.env.DATABASE_URL||"postgresql://localhost:5431/postgres",ssl:"require"===process.env.DATABASE_SSL&&{rejectUnauthorized:!1}})).on("error",e=>{console.error("[DB] Unexpected pool error:",e.message)}),E}function c(e){if(!e)return e;let t=e.names;return t&&""!==t&&"{}"!==t?"string"==typeof t?t=t.replace(/^\{|\}$/g,"").split(",").map(e=>e.trim()).filter(Boolean):Array.isArray(t)||(t=[]):t=[],{...e,names:t,subtasks:e.subtasks||[],notes:e.notes||[],labels:e.labels||[]}}function i(e){return e?Array.isArray(e)?e.join(","):String(e):""}n=(r.then?(await r)():r)[0];let d=`
  SELECT id, message, date, company, names,
    accountrep AS "accountRep", completed, description,
    createdat AS "createdAt", updatedat AS "updatedAt"
  FROM todos
`,T={async getTodos(){let e=s(),[t,a]=await Promise.all([e.query(`${d} WHERE completed = false ORDER BY date DESC`),e.query(`${d} WHERE completed = true ORDER BY date DESC`)]);return{active:t.rows.map(c),completed:a.rows.map(c)}},async addTodo(e){let t=s(),a=e.id||Date.now().toString();await t.query(`INSERT INTO todos (id, message, date, company, names, accountrep, completed, description)
       VALUES ($1, $2, $3, $4, $5, $6, false, $7)`,[a,e.message,e.date,e.company||"",i(e.names),e.accountRep||"",e.description||""]);let o=await t.query(`${d} WHERE id = $1`,[a]);return c(o.rows[0])},async updateTodo(e,t){let a=s(),o={message:"message",date:"date",company:"company",names:"names",accountRep:"accountrep",description:"description"},n=Object.keys(t).filter(e=>o[e]);if(n.length>0){let r=n.map((e,t)=>`${o[e]} = $${t+1}`).join(", "),s=n.map(e=>"names"===e?i(t[e]):t[e]);s.push(e),await a.query(`UPDATE todos SET ${r}, updatedat = CURRENT_TIMESTAMP WHERE id = $${s.length}`,s)}let r=await a.query(`${d} WHERE id = $1`,[e]);return c(r.rows[0])},async deleteTodo(e){let t=s();await t.query("DELETE FROM todos WHERE id = $1",[e])},async completeTodo(e){let t=s();await t.query("UPDATE todos SET completed = true, updatedat = CURRENT_TIMESTAMP WHERE id = $1",[e])},async uncompleteTodo(e){let t=s();await t.query("UPDATE todos SET completed = false, updatedat = CURRENT_TIMESTAMP WHERE id = $1",[e])},async saveTodos(e){let t=s(),a=e.active||[],o=e.completed||[],n=new Date().toISOString(),r=`
    ...
    `);try{await e.query("ALTER TABLE todos ADD COLUMN IF NOT EXISTS description TEXT")}catch{}console.log("[DB] Tables ready")}};o()}catch(e){o(e)}})}};var t=require("../../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),o=t.X(0,[276,972],()=>a(2273));module.exports=o})();