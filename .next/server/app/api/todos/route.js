"use strict";(()=>{var e={};e.id=603,e.ids=[603],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},4181:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{originalPathname:()=>y,patchFetch:()=>E,requestAsyncStorage:()=>T,routeModule:()=>d,serverHooks:()=>u,staticGenerationAsyncStorage:()=>p});var r=a(9303),n=a(8716),s=a(670),c=a(2918),i=e([c]);c=(i.then?(await i)():i)[0];let d=new r.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/todos/route",pathname:"/api/todos",filename:"route",bundlePath:"app/api/todos/route"},resolvedPagePath:"/Users/markwilliams/Documents/Developer-Projects/TODO-Tracker/app/api/todos/route.js",nextConfigOutput:"",userland:c}),{requestAsyncStorage:T,staticGenerationAsyncStorage:p,serverHooks:u}=d,y="/api/todos/route";function E(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:p})}o()}catch(e){o(e)}})},2918:(e,t,a)=>{a.a(e,async(e,o)=>{try{a.r(t),a.d(t,{GET:()=>c,POST:()=>i,PUT:()=>E});var r=a(7070),n=a(6385),s=e([n]);async function c(){try{let e=await n.db.getTodos();return r.NextResponse.json(e)}catch(e){return console.error("[API /todos GET]",e.message),r.NextResponse.json({error:e.message},{status:500})}}async function i(e){try{let t=await e.json(),a=await n.db.addTodo(t);return r.NextResponse.json(a)}catch(e){return console.error("[API /todos POST]",e.message),r.NextResponse.json({error:e.message},{status:500})}}async function E(e){try{let t=await e.json();return await n.db.saveTodos(t),r.NextResponse.json({ok:!0})}catch(e){return console.error("[API /todos PUT]",e.message),r.NextResponse.json({error:e.message},{status:500})}}n=(s.then?(await s)():s)[0],o()}catch(e){o(e)}})},6385:(e,t,a)=>{a.a(e,async(e,o)=>{try{let E;a.d(t,{db:()=>T});var r=a(8678),n=e([r]);function s(){return E||(E=new r.Pool({connectionString:process.env.DATABASE_URL||"postgresql://localhost:5431/postgres",ssl:"require"===process.env.DATABASE_SSL&&{rejectUnauthorized:!1}})).on("error",e=>{console.error("[DB] Unexpected pool error:",e.message)}),E}function c(e){if(!e)return e;let t=e.names;return t&&""!==t&&"{}"!==t?"string"==typeof t?t=t.replace(/^\{|\}$/g,"").split(",").map(e=>e.trim()).filter(Boolean):Array.isArray(t)||(t=[]):t=[],{...e,names:t,subtasks:e.subtasks||[],notes:e.notes||[],labels:e.labels||[]}}function i(e){return e?Array.isArray(e)?e.join(","):String(e):""}r=(n.then?(await n)():n)[0];let d=`
...
`,T={async getTodos(){let e=s(),[t,a]=await Promise.all([e.query(`${d} WHERE completed = false ORDER BY date DESC`),e.query(`${d} WHERE completed = true ORDER BY date DESC`)]);return{active:t.rows.map(c),completed:a.rows.map(c)}},async addTodo(e){let t=s(),a=e.id||Date.now().toString();await t.query(`INSERT INTO todos (id, message, date, company, names, accountrep, completed, description)
    ...
    `);try{await e.query("ALTER TABLE todos ADD COLUMN IF NOT EXISTS description TEXT")}catch{}console.log("[DB] Tables ready")}};o()}catch(e){o(e)}})}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),o=t.X(0,[276,972],()=>a(4181));module.exports=o})();